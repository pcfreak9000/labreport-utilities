...
@Command(name = "", subcommands = { CreateCommand.class, SetFromFileCommand.class, PropagateCommand.class, TexCommand.class, PrintTabletCommand.class, SetCommand.class })
